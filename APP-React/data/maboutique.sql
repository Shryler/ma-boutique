...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : jeu. 08 sep. 2022 à 16:25
...
INSERT INTO `app_user` (`id`, `password`, `mail`, `active`, `is_deleted`) VALUES
...
INSERT INTO `command` (`id`, `date_ordered`, `cmd_number`, `status`, `bill_nb`, `is_deleted`, `id_customer`) VALUES
...
INSERT INTO `customer` (`id`, `inscription`, `civility`, `name`, `surname`, `birthdate`, `address`, `country_code`, `city`, `phone_number`, `is_deleted`, `id_app_user`) VALUES
(1, '2022-06-25', 'Mrs', 'Overell', 'Inessa', '2021-10-26', '0 Burrows Court', 0, 'Umeå', 2147483647, 1, NULL),
...
INSERT INTO `img` (`id`, `url`, `is_deleted`) VALUES
(1, 'https://media.ldlc.com/r1600/ld/products/00/05/21/61/LD0005216148_2.jpg', NULL),
(2, 'https://media.ldlc.com/r1600/ld/products/00/05/21/61/LD0005216163_2.jpg', NULL),
(3, 'https://media.ldlc.com/r1600/ld/products/00/05/21/61/LD0005216153_2.jpg', NULL),
(4, 'https://media.ldlc.com/r1600/ld/products/00/05/92/79/LD0005927989_1.jpg', NULL),
(5, 'https://media.ldlc.com/r1600/ld/products/00/05/92/79/LD0005927990_1.jpg', NULL);
...
INSERT INTO `img_product` (`id_img`, `id_product`, `id`) VALUES
(1, 1, 1),
(2, 1, 2),
(3, 1, 3),
(4, 2, 4),
...
INSERT INTO `product` (`id`, `designation`, `min_description`, `description`, `current_price`, `current_rate_tva`, `stock_min`, `stock_qty`, `stock_max`, `is_deleted`, `id_brand`) VALUES
...
ALTER TABLE `customer`
  ADD CONSTRAINT `customer_ibfk_1` FOREIGN KEY (`id_app_user`) REFERENCES `app_user` (`id`);

--
-- Contraintes pour la table `img_product`
--
ALTER TABLE `img_product`
  ADD CONSTRAINT `img_product_ibfk_1` FOREIGN KEY (`id_img`) REFERENCES `img` (`id`),
  ADD CONSTRAINT `img_product_ibfk_2` FOREIGN KEY (`id_product`) REFERENCES `product` (`id`);
